...
# class PrefnuggetIterativeExtractDifferentiatingNuggets(dspy.Signature):
#     __doc__ = dedent(
#       """
...
# class GroundedNuggetQuestionsReportRequest(dspy.Signature):
#     __doc__ = dedent(
#         """
...
# =============================================================================
# GroundRubricJudge Implementation
# =============================================================================

class GroundRubricJudge(AutoJudge):
    """
    ...
    def create_nuggets(
        ...
        **kwargs
        ...
        if prompt == "ground-nugget-baseline":
            prompt_sig = GroundedIterativeExtractDifferentiatingNuggets
        else:
