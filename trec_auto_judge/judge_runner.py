...
from .nugget_data.nugget_banks import write_nugget_banks
...
def run_judge(
    ...
    if create_nuggets:
        ...
        if current_nuggets is not None and store_nuggets_path:
            write_nugget_banks(current_nuggets, store_nuggets_path)
    ...
    if rag_responses is not None:
        ...
        if modify_nuggets and emitted_nuggets is not None:
            ...
            if store_nuggets_path:
                write_nugget_banks(emitted_nuggets, store_nuggets_path)
